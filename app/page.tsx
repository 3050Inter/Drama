...
function LaborPage({ date, onChanged }: { date: string; onChanged: () => Promise<void> }) {
  ...
  const filteredRows = useMemo(() => rows.filter((r) => filterEmployee === "전체" || r.employee === filterEmployee), [rows, filterEmployee]);
