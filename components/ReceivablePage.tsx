...
export default function ReceivablePage({
  ...
  const pay = async (id: string, full?: boolean, balance?: number) => {
    ...
    if (full) await completeReceivable(id, method, memoText || "완납");
    else await payReceivable(id, value, method, memoText);
